...
# Getting media stats
#
# We get the number of views for a media (stats.COUNTRY_CODE.TIME_INTERVAL)
# COUNTRY_CODE value: 'global' or a specififc country code (fr, uk...)
# TIME_INTERVAL value: 'last_minute', 'last_hour', 'last_month', 'last_year', 'total', 'last_week' or 'last_day'
